# Generated by Django 4.1 on 2023-03-15 02:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "ordering": ("-last_checked_at", "-created_at", "ip_address", "id"),
                "index_together": {
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("asn_id", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="jpnic_admin.jpnic")),
            ],
            options={
                "ordering": ("-last_checked_at", "-created_at", "asn_id"),
            },
        ),
        migrations.CreateModel(
            name="JPNICHandle",
            ...
            options={
                "ordering": ("-last_checked_at", "-created_at", "id"),
                "index_together": {
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ("-last_checked_at", "-created_at", "asn_id"),
                "index_together": {("last_checked_at", "asn_id"), ("created_at", "last_checked_at", "asn_id")},
            },
        ),
    ]
