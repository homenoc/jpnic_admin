# Generated by Django 4.1 on 2022-09-08 18:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=120, verbose_name='名前')),
                ('name_en', models.CharField(db_index=True, max_length=120, verbose_name='名前(英語)')),
                ('email', models.CharField(db_index=True, max_length=50, verbose_name='メールアドレス')),
                ('org', models.CharField(db_index=True, max_length=120, verbose_name='組織名')),
                ('org_en', models.CharField(db_index=True, max_length=120, verbose_name='組織名(英語)')),
                ('division', models.CharField(blank=True, db_index=True, max_length=120, null=True, verbose_name='部署')),
                ('division_en', models.CharField(blank=True, db_index=True, max_length=120, null=True, verbose_name='部署(英語)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_server', models.CharField(blank=True, max_length=200, null=True, verbose_name='ネームサーバ')),
                ('ds_record', models.CharField(blank=True, max_length=500, null=True, verbose_name='DSレコード')),
                ('notify_address', models.CharField(blank=True, max_length=200, null=True, verbose_name='通知アドレス')),
