"""
Django settings for jpnic_gui project.
...
from jpnic_gui.templatetags import extra
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'jpnic_gui.templatetags.extra'
            ]
        },
    },
]

WSGI_APPLICATION = 'jpnic_gui.wsgi.application'
