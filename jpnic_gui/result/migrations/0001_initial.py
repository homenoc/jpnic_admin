    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_jpnic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='v6lists', to='result.jpnichandle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ds_record', models.CharField(blank=True, max_length=100, null=True, verbose_name='DSレコード')),
                ('notify_address', models.CharField(blank=True, max_length=100, null=True, verbose_name='通知アドレス')),
                ('admin_jpnic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='v4lists', to='result.jpnichandle')),
